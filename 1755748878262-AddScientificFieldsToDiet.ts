...
export class AddScientificFieldsToDiet1755748878262 implements MigrationInterface {
    name = 'AddScientificFieldsToDiet1755748878262'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "diets" ADD "description" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "diets" ADD "trainingFrequency" character varying(20)`);
        await queryRunner.query(`ALTER TABLE "diets" ADD "activityType" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "diets" ADD "macroDistribution" jsonb`);
        await queryRunner.query(`ALTER TABLE "diets" ADD "scientificValidation" jsonb`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "diets" DROP COLUMN "scientificValidation"`);
        await queryRunner.query(`ALTER TABLE "diets" DROP COLUMN "macroDistribution"`);
        await queryRunner.query(`ALTER TABLE "diets" DROP COLUMN "activityType"`);
        await queryRunner.query(`ALTER TABLE "diets" DROP COLUMN "trainingFrequency"`);
        await queryRunner.query(`ALTER TABLE "diets" DROP COLUMN "description"`);
